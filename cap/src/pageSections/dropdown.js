...
function Dropdown() {
  ...
  useEffect(() => {
    setPrimary([
      {
        name: "Tabletop",
        secondary: ["40K", "A.O.S", "Other"],
        tertiary: ["Competetive", "Casual"],
        penultimate: ["2000", "1000", "500"],
      },
      {
        name: "Cardgames",
        secondary: ["M.T.G", "Flesh and Blood", "Other"],
        tertiary: ["Classic", "Commander", "2.H.G"],
        penultimate: ["Sealed", "Draft", "Constructed"],
      },
      {
        name: "Roleplay",
        secondary: ["Player", "D.M."],
        tertiary: ["Campaign", "One-shot"],
        penultimate: ["Paid", "F2P"],
      },
      {
        name: "Boardgames",
        secondary: ["Co-op", "Versus"],
        tertiary: ["Head to head", "Multi-player"],
        penultimate: ["Strategy", "4x"],
      },
    ]);
  }, []);
