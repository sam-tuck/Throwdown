...
function Post() {
  ...
  const { gametype, system, ruleset, systype, gamesinfo, setGamesinfo } =
    useSetting();
  ...
  function idUp() {
    axios
      .post("http://localhost:4000/user/changedeetsup", {
  ...
  function idDown() {
    axios
      .post("http://localhost:4000/user/changedeetsdown", {
        idgames: gamesinfo.idgames - 1,
      })
      .then((Response) => {
        setGamesinfo(Response.data);
    ...
    <div>
      ...
      <div className="flex">
        ...
        <span className="content">
          <Gamedeets />
          <p className="type">
            These are your games. Update or delete them on the right
          </p>
        </span>

        <button className="navBtn" id="right" onClick={idUp}>
        ...
        <span className="content">
          <form action="post">
            ...
            ></textarea>
            <br></br>
            <button id="submit" type="submit" onClick={updateEvent}>
              Uptate
            </button>
            <button id="submit" type="submit" onClick={deleteEvent}>
              Delete
            </button>
          </form>
        </span>
